...
import { PromotionsByDay } from "@/components/promotions/PromotionsByDay";
...
export default async function PromocionesPage() {
  ...
  /*
   * El usuario autenticado puede obtener todas las
   * promociones mediante las políticas RLS.
   */
  const restaurants =
    await getPublicRestaurants();

  /*
   * En lugar de filtrar solamente las promociones de hoy,
   * enviamos todas las promociones activas al componente
   * cliente para filtrarlas al seleccionar una fecha.
   */
  const promotions: PublicPromotionWithRestaurant[] =
